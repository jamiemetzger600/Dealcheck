...
// Don't declare VERSION to avoid conflicts with page scripts
// Just use window.EXTENSION_VERSION directly throughout the code
(function() {
    // Create local VERSION variable only for this extension's use
    window.DA_VERSION = `v${window.EXTENSION_VERSION || '2.2.0'}`;
})();
...
<div id="deal-analyzer-container">
  <div id="deal-analyzer-header">
    Deal Analyzer <span style="font-size:11px; opacity:0.8; font-weight:400;">${window.DA_VERSION}</span>
...
<body>
  ...
  <div class="footer">
    Generated by Max Price Deal Analyzer ${window.DA_VERSION}
  </div>
</body>
</html>`;
  } catch (error) {
